  ...
  return (
    <div className="app-layout">
      ...
      <div className="main-content">
        <TopBar pathname="/copilot" />
        <main className="page-body" style={{ display: 'flex', gap: 20, overflow: 'hidden', height: 'calc(100vh - 64px)' }}>
          {/* Chat Panel */}
          ...
          <div style={{ width: 280, flexShrink: 0, display: 'flex', flexDirection: 'column', gap: 16, overflowY: 'auto' }}>
            ...
            <div className="card" style={{ background: 'rgba(99,102,241,0.06)', borderColor: 'rgba(99,102,241,0.2)' }}>
              ...
              <div style={{ fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.6 }}>
                Powered by <strong style={{ color: 'var(--text-secondary)' }}>Gemini 1.5 Flash</strong><br />
