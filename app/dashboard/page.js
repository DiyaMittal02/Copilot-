  ...
  return (
    <AppShell>
      <main className="page-body">
          {/* Visual Hero Panel */}
          <div className="card hero-gradient-card" style={{ marginBottom: 24, padding: '28px 32px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 16 }}>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
                  <span className="custom-status-badge badge-active-glow">🟢 Active Monitoring</span>
                  <span style={{ fontSize: 12, color: 'var(--text-accent)', fontWeight: 600 }}>POCKETFM PLATFORM COGNITIVE FEED</span>
                </div>
                <h2 className="glow-text-purple" style={{ fontSize: 26, fontWeight: 800, color: 'var(--text-primary)', marginBottom: 8, letterSpacing: '-0.02em' }}>
                  PocketFM Product Insights Terminal
                </h2>
                <p style={{ fontSize: 13, color: 'var(--text-secondary)', maxWidth: 640, lineHeight: 1.6 }}>
                  Identify drop-off loops, simulate pricing updates, optimize episode releases, and run diagnostic autopsies directly across 18.3M active audience genomes.
                </p>
              </div>
              <div style={{ display: 'flex', gap: 10, marginTop: 8 }}>
                <a href="/optimization" className="btn btn-primary" style={{ padding: '10px 16px', fontSize: 12 }}>🎚️ Simulate Pricing</a>
                <a href="/copilot" className="btn btn-secondary" style={{ padding: '10px 16px', fontSize: 12 }}>🤖 Consult Copilot</a>
              </div>
            </div>
          </div>
